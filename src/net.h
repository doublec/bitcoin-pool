...
#ifndef _bitcoin_net_h_
#define _bitcoin_net_h_
...
static unsigned short nCurrentListenPortNS = 0;
inline unsigned short GetDefaultPort() { return fTestNet ? htons(18333) : DEFAULT_PORT; }
